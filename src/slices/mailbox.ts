...
export const getTags = (): AppThunk => async (dispatch) => {
  const response = await axios.get<{ tags: Tag[] }>("/mailbox/tags");
...
export const getMails =
  (params: {}): AppThunk =>
  async (dispatch) => {
    const response = await axios.get<{ mails: Mail[] }>("/mailbox/mails", {
      params,
    });
...
export const getMail =
  ...
  async (dispatch) => {
    const response = await axios.get<{ mail: Mail }>("/mailbox/mail", {
      params: {
        mailboxCategory,
      },
    });
